...
from core.views.this_api.this_api_sync_gitlab_view.this_api_sync_gitlab_view import this_api_sync_gitlab_view
...
urlpatterns_this_api: list[URLPattern | URLResolver] = [
    path(name="this_api_sync_gitlab", route="api/sync_gitlab/", view=this_api_sync_gitlab_view),
