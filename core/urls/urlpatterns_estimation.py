...
urlpatterns_estimation: list[URLPattern | URLResolver] = [
    ...
    path(name="estimation_group_move_up", route="estimation/<int:estimation_id>/group/move-up/", view=estimation_group_move_up_view),
    path(name="estimation_group_move_down", route="estimation/<int:estimation_id>/group/move-down/", view=estimation_group_move_down_view),
    path(name="estimation_group_move_to_top", route="estimation/<int:estimation_id>/group/move-to-top/", view=estimation_group_move_to_top_view),
    path(name="estimation_group_move_to_bottom", route="estimation/<int:estimation_id>/group/move-to-bottom/", view=estimation_group_move_to_bottom_view),
