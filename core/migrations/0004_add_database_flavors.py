...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('Azure Blob Storage', 'Azure Blob Storage'), ('CosmosDB', 'CosmosDB'), ('MariaDB', 'MariaDB'), ('MinIO', 'MinIO'), ('MongoDB', 'MongoDB'), ('PostgreSQL', 'PostgreSQL'), ('SQLite', 'SQLite')], max_length=255, null=True),
        ),
        migrations.AlterField(
