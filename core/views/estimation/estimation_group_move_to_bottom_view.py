...
def estimation_group_move_to_bottom_view(request: HttpRequest, estimation_id: int, group_name: str) -> HttpResponse:
    """Move a group to the bottom of the order."""
    try:
        ...
        # Remove the group from its current position and append at the end
