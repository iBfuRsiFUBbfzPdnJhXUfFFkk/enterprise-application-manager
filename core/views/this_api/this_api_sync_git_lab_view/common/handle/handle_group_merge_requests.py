...
from core.views.this_api.this_api_sync_git_lab_view.common.fetch.fetch_group_merge_requests import fetch_group_merge_requests
from core.views.this_api.this_api_sync_git_lab_view.common.fetch.fetch_git_lab_group import fetch_git_lab_group
from core.views.this_api.this_api_sync_git_lab_view.common.handle.handle_group_merge_request import handle_group_merge_request
...
def handle_group_merge_requests(
    ...
    for group_merge_request in all_group_merge_requests:
        indicator_map: dict[str, IndicatorMap] = handle_group_merge_request(
            git_lab_client=git_lab_client,
