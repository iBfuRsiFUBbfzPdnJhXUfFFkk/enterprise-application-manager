...
def _calculate_sprint_metrics(sprint):
    ...
    total_delivered = sum(kpi.number_of_story_points_delivered for kpi in kpis)
    total_committed = sum(kpi.number_of_story_points_committed_to for kpi in kpis)
    total_reviews = sum(kpi.number_of_merge_requests_approved for kpi in kpis)
